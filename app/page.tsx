...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#121212]">
      {/* Header/Nav */}
      <header className="border-b border-[#1E1E1E] relative z-50">
        <nav className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="text-2xl font-bold text-[#10B981]">Splitzz</div>
    ...
    <section className="container mx-auto px-6 py-20">
      <div className="flex flex-col items-center">
        ...
        <div className="text-center max-w-4xl mb-12">
          ...
          <p className="text-lg lg:text-xl text-[#E5E5E5] mb-8 text-pretty leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-[#10B981] hover:bg-[#059669] text-white text-lg px-8 shadow-lg shadow-[#10B981]/30"
            >
              Get Started Free
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="border-[#E5E5E5]/50 text-white hover:bg-white/10 bg-transparent"
            >
              Watch Demo
            </Button>
          </div>
        ...
        <div className="w-full max-w-6xl relative">
          ...
          <div className="absolute -inset-4 bg-[#10B981] opacity-20 blur-3xl rounded-3xl" />
          <div className="relative rounded-2xl overflow-hidden border border-[#10B981]/30 shadow-2xl shadow-[#10B981]/20">
            <Image
  ...
  return (
    <section id="features" className="container mx-auto px-6 py-20">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <Card className="bg-[#1E1E1E] border-[#2a2a2a] p-8 hover:border-[#10B981] transition-colors">
...
const CTASection = memo(function CTASection() {
  return (
    <section className="container mx-auto px-6 py-20">
      <Card className="bg-gradient-to-br from-[#1E1E1E] to-[#121212] border-[#10B981] p-12 lg:p-16 text-center relative overflow-hidden">
        {/* Decorative glow */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#10B981] opacity-10 blur-3xl rounded-full" />
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#22C55E] opacity-10 blur-3xl rounded-full" />
        ...
        <div className="relative z-10">
          ...
          <Button
            size="lg"
            className="bg-[#10B981] hover:bg-[#059669] text-white text-lg px-12"
          >
            Create Free Account
          </Button>
        </div>
  ...
  return (
    <footer className="border-t border-[#1E1E1E] mt-20">
      <div className="container mx-auto px-6 py-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
                  className="text-[#A1A1AA] hover:text-[#10B981] text-sm"
                >
                  Features
                </a>
              </li>
        ...
        <div className="border-t border-[#1E1E1E] mt-8 pt-8 text-center text-[#A1A1AA] text-sm">
